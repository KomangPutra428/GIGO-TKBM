...
public class rekap_absensi extends AppCompatActivity {
    ListView list_absen;
    ImageButton filter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        filter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Dialog filter = new Dialog(rekap_absensi.this);
                ...
                mulai_tanggal.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        DatePickerDialog datePickerDialog = new DatePickerDialog(rekap_absensi.this, dateSetListener, currentDate.get(Calendar.YEAR), currentDate.get(Calendar.MONTH), currentDate.get(Calendar.DAY_OF_MONTH));
    ...
    private void getAbsen(String mulai_tanggal, String sampai_tanggal) {
        pDialog = new SweetAlertDialog(rekap_absensi.this, SweetAlertDialog.PROGRESS_TYPE);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET,"https://hrd.tvip.co.id/rest_server/pengajuan/Absenmobile/index_cek_absengigo?tanggal1="+convertFormat2(mulai_tanggal)+"&tanggal2="+convertFormat2(sampai_tanggal)+"&nik=" + nik_baru,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        new SweetAlertDialog(rekap_absensi.this, SweetAlertDialog.WARNING_TYPE)
...
//                viewHolder.no_bkb = (TextView) convertView.findViewById(R.id.no_bkb);
            ...
            viewHolder.tanggal.setText(convertFormatdate(movieItem.getShift_day()) + " • " + movieItem.getKet_absensi());
